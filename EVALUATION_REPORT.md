...
2.  ✅ **实例化渲染 (Instancing)**: 解决市场数量增多后的性能崩溃风险 (已实施资源共享优化)。

**P1 (近期规划):**
1.  ✅ **音频总线管理**: 修复潜在的音频 Bug (已实现 AudioManager)。
2.  ✅ **碰撞交互**: 提升核心玩法的趣味性 (已实现物理碰撞触发)。

**P2 (持续迭代):**
1.  ✅ **AR 导航路径**: 增强实用性 (已实现 3D 箭头)。
2.  ✅ **Web Worker 物理引擎**: 为未来更复杂的物理效果打基础。
3.  ✅ **多视角系统**: 支持 Follow/Top/Driver 三种视角。
4.  ✅ **新手引导**: 新增首次进入的教学遮罩。
5.  ✅ **仪表盘**: 新增速度表和 HUD 整合。
6.  ✅ **DOM 优化**: 全局 Tooltip 单例化。
7.  ✅ **无障碍**: 支持 Tab 键键盘导航。
