 ...
 */
export const transformEventToMarket = (event: any, participantCount: number = 0) => {
  ...
  return {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&q=80&w=1000', // 默认图
